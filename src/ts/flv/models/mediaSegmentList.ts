export default class MediaSegmentList {
    ...
    _searchNearestSegmentBefore(beginDts: any) {
    ...
    _searchNearestSegmentAfter(beginDts: any) {
    ...
    getLastSegmentBefore(beginDts: any) {
    ...
    getLastSampleBefore(beginDts: any) {
        const segment = this.getLastSegmentBefore(beginDts)
        if (segment !== null) {
